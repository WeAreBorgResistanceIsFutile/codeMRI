...
public class ComponentIdentificationServiceTests
{
    ...
    public void Setup()
    {
        ...
        _service = new ComponentIdentificationService(_mockLogger.Object, new Mock<IProgressService>().Object,
            new Mock<ILoggerFactory>().Object, new Mock<IASTServiceClient>().Object);
