...
public class ArchitecturalPatternServiceTests
{
    ...
    public void RecognizePattern_ShouldDetectMVC_WithAllThreeComponents()
    {
        ...
        _graph.AddEdge("UserModel", "UserController", EdgeType.Dependency,
            1.0); // Model depends on Controller (violates Clean Arch)
    ...
    public void DetermineLayer_ShouldReturnPresentation_ForPresentationKeywords(string componentName,
        string componentType, ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
    ...
    public void DetermineLayer_ShouldReturnApplication_ForApplicationKeywords(string componentName,
        string componentType, ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
    ...
    public void DetermineLayer_ShouldReturnDomain_ForDomainKeywords(string componentName, string componentType,
        ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
            ComponentId = componentName,
    ...
    public void DetermineLayer_ShouldReturnData_ForDataKeywords(string componentName, string componentType,
        ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
    ...
    public void DetermineLayer_ShouldReturnInfrastructure_ForInfrastructureKeywords(string componentName,
        string componentType, ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
    ...
    public void DetermineLayer_ShouldReturnCrossCutting_ForCrossCuttingKeywords(string componentName,
        string componentType, ArchitecturalLayerType expected)
    {
        var node = new GraphNode
        {
