...
namespace codeMRI.Core.Tests.Services
{
    ...
    public class UnifiedLanguageProcessingTests
    {
        ...
        public async Task BuildGraphAsync_ShouldProcessRichDependencyGraph_FromASTService()
        {
            ...
            {
                new CodeComponent { Id = "comp1", FilePath = "/src/main.py", Language = "python", Type = "Script" },
                new CodeComponent { Id = "comp2", FilePath = "/src/utils.js", Language = "javascript", Type = "Module" }
            };
            ...
            var pythonGraph = new DependencyGraphData
            {
                ...
                {
                    new ASTGraphNode { Id = "func_main", Type = "function", Language = "python" },
                    new ASTGraphNode { Id = "class_helper", Type = "class", Language = "python" }
                },
                Edges = new List<ASTGraphEdge>
                {
                    new ASTGraphEdge { Source = "func_main", Target = "class_helper", Type = "Usage" },
                    new ASTGraphEdge { Source = "func_main", Target = "utils_module", Type = "Import" } // Cross-lang ref
                }
            };
            ...
            _mockAstService.Setup(s => s.ParseCodeAsync(It.IsAny<string>(), "python", "/src/main.py", It.IsAny<CancellationToken>()))
            ...
            _mockAstService.Setup(s => s.ParseCodeAsync(It.IsAny<string>(), "python", pyPath, It.IsAny<CancellationToken>()))
               .ReturnsAsync(pythonResult);
             ...
             var jsGraph = new DependencyGraphData
            {
                Nodes = new List<ASTGraphNode>
                {
                    new ASTGraphNode { Id = "utils_module", Type = "module", Language = "javascript" }
                },
                Edges = new List<ASTGraphEdge>()
            };
            ...
            _mockAstService.Setup(s => s.ParseCodeAsync(It.IsAny<string>(), "javascript", jsPath, It.IsAny<CancellationToken>()))
