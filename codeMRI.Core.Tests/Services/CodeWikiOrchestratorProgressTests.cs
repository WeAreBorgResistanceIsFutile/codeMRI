...
public class CodeWikiOrchestratorProgressTests
{
    ...
    public async Task GenerateAdvancedWikiAsync_ReportsProgress()
    {
        ...
        _mockWikiGenerationService.Setup(x => x.GeneratePageAsync(It.IsAny<string>(), It.IsAny<List<string>>(), It.IsAny<Dictionary<string, string>>(), It.IsAny<string>(), It.IsAny<string?>()))
