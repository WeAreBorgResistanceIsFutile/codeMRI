...
public class DiagramGeneratorServiceTests
{
    ...
    private void SetupMicroservicesGraph()
    {
        ...
        // Service 1
        _graph.AddNode("OrderAPI",
            new NodeMetadata
                { Type = "API", Properties = new Dictionary<string, object> { { "Module", "OrderService" } } });

        // Service 2
        _graph.AddNode("UserAPI",
            new NodeMetadata
                { Type = "API", Properties = new Dictionary<string, object> { { "Module", "UserService" } } });
