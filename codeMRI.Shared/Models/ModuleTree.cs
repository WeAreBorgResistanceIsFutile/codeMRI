...
namespace codeMRI.Shared.Models
{
    ...
    public class ModuleTree
    {
        ...
        /// </summary>
        public ModuleNode Root { get; set; } = new ModuleNode { Id = "root", Name = "Repository" };
        
        /// <summary>
        /// All nodes in the tree by ID
        /// </summary>
        public Dictionary<string, ModuleNode> Nodes { get; set; } = new Dictionary<string, ModuleNode>();
    ...
    public class ModuleNode
    {
        ...
        public HashSet<string> Components { get; set; } = new HashSet<string>();
